...
<main class="">
        ...
        <div class="<?=$section_padding ?>">
            <div class="row">
                ...
                <div class="col-lg-6 pb-5 pb-md-4">
                    <div data-aos="fade-right" class="banner-wrap site-radius px-4 pt-4 px-md-5 pt-md-0 banner-grid grid-dark" style="background: var(--color-banner-bg2);">
            
                        <!-- Banner Heading -->
                        <div class="banner-content pb-0 pt-md-5 justify-content-end">
                            <span class="px-4 py-1 text-primary fw-bold rounded-pill uppercase mb-3 bg-light text-uppercase fs-8" style="letter-spacing: 2;" data-aos="flip-left">Premium Experience</span>
                            <h2 class="<?=$section_title_bold; ?> mb-3" data-aos="fade-up"> Get your tailoring needs met from the comfort of your home. </h2>
                            <a class="fs-6 text-primary pb-5" data-aos="fade-up">Learn More<span class="material-symbols-outlined text-primary fs-7">arrow_forward</span> </a>
                        
                            <div class="overflow-hidden rounded-4" style="transform: translateY(25px);">
                                <img alt="Professional tailor taking measurements of a Nigerian woman in a modern apartment" class="w-100 object-fit-cover" data-aos="fade-in" style="aspect-ratio: 4 / 3;" src="./img/home/screen.png"/>
                            </div>
                        </div>
                ...
                <div class="col-lg-6 pb-5 pb-md-4">
                    <div data-aos="fade-right" class="banner-wrap site-radius px-4 pt-4 px-md-5 pt-md-0 banner-grid" style="background: var(--color-banner-bg);">
    
                        <div class="banner-content pb-0 pt-md-5 justify-content-end">
                            <span class="px-4 py-1 text-white fw-bold rounded-pill uppercase mb-3 text-uppercase fs-8" style="letter-spacing: 2; background: rgba(225,225,225, 0.3)" data-aos="flip-left">The <?=$company_name?> Promise</span>
                            <h2 class="text-white <?=$section_title_bold; ?> mb-3" data-aos="fade-up"> No more tailor drama </h2>
                            <p class="text-light fs-6-plus mb-4" data-aos="fade-up">Money Back Guarantee if your needs aren't met.</p>
                            <a class="text-white fs-6 text-white pb-5" data-aos="fade-up">Learn More <span class="material-symbols-outlined text-white fs-7">arrow_forward</span> </a>
                        
                            <div class="overflow-hidden rounded-4 w-100" style="transform: translateY(25px);">
                                <img alt="Professional tailor taking measurements of a Nigerian woman in a modern apartment" class="rounded-4 w-100 object-fit-cover" data-aos="fade-in" style="aspect-ratio: 4 / 3;" src="https://lh3.googleusercontent.com/aida-public/AB6AXuA0IVam1X3bPObq8ehAHvl3Xi73OaxgA6Li67i7AI4RFi1fSvmgRgjza-EaDTo9wL1DgSIMnuARKheaFCyyBUhSK6SyUB0IpvIeuN6zxRKla1wh1HE9hZd1DY0xJ3O6Fvc9uVLrdP8jq7BodYYGMj_puXAzhC6rEgHXW-jo2VN-3hHRjGfDFcYPeVkmjpjgnm8k7zzFqwggxlsyGLQq_K7UV1702jYD8BfOK8nbup21srr4FmRsFpTZFxbt4hDf0eEOlH4Ee59ceHAk"/>
                            </div>
                        </div>
                ...
                <div class="col-12" data-aos="flip-left">
                    ...
                    <div class="banner-bg site-radius p-4 p-md-5 banner-grid grid-dark" style="background: var(--color-banner-bg2);">
                        ...
                        <div class="d-flex flex-column align-items-center justify-content-center flex-lg-row justify-content-lg-between">
                            ...
                            <div class="pe-lg-5 text-center text-lg-start">
                                ...
                                <p class="<?=$body_text?> w-100" data-aos="flip-left">
                                    Explore styles, connect with tailors all over port harcourt, and bring your fashion ideas to life today.
                                </p>
                            </div>
                            <div>
    
                                <a href="" class="btn btn-primary rounded-3 px-4 py-2 fs-6" data-aos="flip-left"> Explore Styles </a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="container-xl py-5 overflow-hidden" id="banners">
        ...
        <div class="pb-4" id="section-primary">
            <div class="<?=$section_padding ?>">
                <div class="banner-wrap site-radius banner-grid grid-dark p-lg-5" data-aos="fade-right">
                    ...
                    <div class="row flex-column-reverse flex-lg-row">
                        ...
                        <div class="col-lg-6 ">
                            <div class="banner-content p-4 p-lg-0 pe-lg-4">
                                ...
                                <p class="text-muted fs-6-plus mb-4" data-aos="fade-up" >From high-end residential renovations to critical electrical infrastructure, see the caliber of work our verified professionals deliver daily.</p>
                                <button class="btn btn-primary rounded-2 px-5 py-2 fs-6 w-100 w-md-75 w-lg-75 w-xl-50" data-aos="fade-up" >Explore Portfolio</button>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 pt-4 pt-sm-5 pt-lg-0">
                            ...
                            <div class="carousel-outer carousel-primary" id="carousel-primary-outer" data-aos="fade-right" >
        ...
        <div class="pb-5 mb-2 <?=$section_padding?>">
            ...
            <div id="fabric-house">
                <div>
                    ...
                    <!-- Hero Banner -->
                    <div class="mb-4">
                        <div class="fabric-hero site-radius" data-aos="fade-right">
                            ...
                            <div class="fabric-hero-overlay d-flex align-items-center justify-content-center">
                                ...
                                <div class="text-center">
                                    ...
                                    <p class="fs-6 text-white mb-4" data-aos="flip-left" >Find your fabric and send it straight <br> to your tailor for free or <br> get it delivered to your doorstep.</p>
                        ...
                        <?php foreach ($fabric_cards as $i => $card): ?>
                            <div class="col-12 col-md-4" data-aos="fade-up" data-aos-delay="<?=$i * 50 ?>">
                                ...
                                <div class="fabric-card-overlay">
                                    <span class="<?=$section_title_bold?> text-uppercase fs-4"><?= htmlspecialchars($card['name']) ?></span>
                                </div>
                                </a>
                            </div>
                        <?php endforeach; ?>
        ...
        <!-- Discount Banner -->
        <div class="<?=$section_padding ?>">
            <div class="hero-gradient p-4 p-md-5 site-radius banner-grid grid-mid" data-aos="fade-up">
                ...
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-center">
                    ...
                    <div class="text-center text-md-start mb-4 mb-md-0">
                        ...
                        <h2 data-aos="flip-left" class="font-headline fs-3 display-5 mb-3"><span class="font-headline display-3 fw-bolder">Get 20% OFF</span><br>On your first booking
                        </h2>
                        <p data-aos="flip-left"   class="fs-6 opacity-75">Use code <span class="bg-white bg-opacity-25 px-2 py-1 rounded font-monospace fw-bold">ARCHI20</span> at checkout. Valid for all services.</p>
                    </div>
                    <button data-aos="flip-left"  class="btn btn-light  rounded-2 px-5 py-2 fs-6 w-100 w-md-unset text-primary">Claim Discount Now</button>
                </div>
            </div>
        </div>
    </section>
